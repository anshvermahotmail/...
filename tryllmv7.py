...
import numpy as np
try:
    import pyreadline as readline  # windows-compatible readline
except ImportError:
    try:
        import readline  # may still work on non-Windows
    except ImportError:
        readline = None
...
if platform.system() == "Windows":
    print("Running on Windows. Ensuring module compatibility...")
